...
/* Need to get the current location quantity will need it later for the stock movement */
	...
	$PONo = $_SESSION['PO'.$identifier]->OrderNo;
        ...
        echo '<br /><div class=centre>'. _('GRN number'). ' '. $GRN .' '. _('has been processed').'<br /><br/>';
        echo '<a href="' . $rootpath . '/SupplierInvoice.php?SupplierID='. $_SESSION['PO'.$identifier]->SupplierID.'">' .
		_('Create Invoice For '). $_SESSION['PO'.$identifier]->SupplierName. '</a><br /><br />';
	echo '<a href=PDFGrn.php?GRNNo='.$GRN .'&PONo='.$PONo.'>'. _('Print this Goods Received Note (GRN)').'</a><br /><br />';
