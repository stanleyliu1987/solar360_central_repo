<?php
/* $Id: DefineCustAllocsClass.php 3242 2009-12-16 22:06:53Z tim_schofield $*/
...
Class Allocation {
	...
	function add_to_AllocsAllocn ($ID, $TransType, $TypeNo, $TransDate, $AllocAmt, $TransAmount, $ExRate, $DiffOnExch, $PrevDiffOnExch, $PrevAlloc, $PrevAllocRecordID,$RefInvNo){
		// if ($AllocAmt <= ($TransAmount - $PrevAlloc)){

			$this->Allocs[$ID] = new Allocn($ID, $TransType, $TypeNo, $TransDate, $AllocAmt, $TransAmount, $ExRate, $DiffOnExch, $PrevDiffOnExch, $PrevAlloc, $PrevAllocRecordID,$RefInvNo);
			Return 1;
...
Class Allocn {
	...
	function Allocn ($ID, $TransType, $TypeNo, $TransDate, $AllocAmt, $TransAmount, $ExRate, $DiffOnExch, $PrevDiffOnExch, $PrevAlloc, $PrevAllocRecordID,$RefInvNo){
