...
/* $Id: Suppliers.php 4570 2011-05-16 07:41:47Z daintree $ */
...
//		}
		if (!isset($_POST['New'])) {
			...
			unset($_POST['TaxRef']);
                        ...
                        echo '<meta http-equiv="Refresh" content="0; url=' . $rootpath .'/SupplierWarehouse.php?SupplierID=' . $SupplierID . '">';

			echo '<div class="centre">' . _('You should automatically be forwarded to the entry of a new Supplier Warehouse page') .
			'. ' . _('If this does not happen') .' (' . _('if the browser does not support META Refresh') . ') ' .
			'<a href="' . $rootpath . '/SupplierWarehouse.php?SupplierID=' . $SupplierID . '"></a></div>';
