...
//			 {
				...
				$AllAllocations = $AllAllocations + $AllocnItem->AllocAmt;
                                /* Fix invoice allocation error when
                                   Invoice cancelled or modified */
                                //if($AllocnItem->PrevAlloc!=0){
                                //$NewAllocTotal=$AllAllocations;    
                                //}
