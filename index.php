...
<?php
    ...
    if(!isset($_SESSION['trackloginuser'])){
       include('TrackingSuccessLogin.php');
       $_SESSION['trackloginuser']=1;
    }
				...
				<table width="100%" >
					...
					<td class="menu_group_items">  <!-- Orders transaction options -->
						<table width="100%" class="table_index">
                                                        <tr>
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/PlaceSalesOrderWeb.php">' . _('Placed Order from Website') . '</a></p>'; ?>
							</td>
							</tr>
							<tr>
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/SelectOrderItems.php?NewOrder=Yes">' . _('Enter An Order or Quotation') . '</a></p>'; ?>
                                                        ...
                                                        <tr>
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/SelectItemFreight.php?ItemFreight=Yes">' . _('Item Freight Calculation') . '</a></p>'; ?>
							</td>
							</tr>
							<tr>
							<td class="menu_group_item">
							...
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/RecurringSalesOrdersProcess.php?' .sid . '">' . _('Process Recurring Orders') . '</a></p>'; ?>
                                                        ...
                                                        <tr>
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/TrackConsignmentNote.php">' . _('Tracking Consigment Notes') . '</a></p>'; ?>
							</td>
							</tr>
						</table>
					</td>
						...
						<table width="100%" class="table_index">
							...
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/Contracts.php">' . _('Create Contract') . '</a></p>'; ?>
                                                        ...
                                                        <tr>
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/geo_displaymap_customers.php">' . _('Geocoding for customer branches') . '</a></p>'; ?>
							</td>
							</tr>						</table>
					</td>
					</tr>
				...
				<table width="100%">
					...
					<td class="menu_group_items">   <!-- PO Maintenance -->
						<table width="100%" class="table_index">
                                                    <tr>
						    <td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/geo_displaymap_suppliers.php">' . _('Geocoding for suppliers') . '</a></p>'; ?>
					            </td>
						    </tr>
						</table>
					</td>
						...
						<table width="100%" class="table_index">
							...
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/ReorderLevelLocation.php">' . _('Reorder Level By Category/Location') . '</a></p>'; ?>
                                                        ...
                                                        <tr>
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/Z_ImportPriceList.php">' . _('Import Price List') . '</a></p>'; ?>
							</td>
							</tr>
						</table>
					</td>
						...
						<table width="100%" class="table_index">
							...
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/DiscountMatrix.php">' . _('Discount Matrix') . '</a></p>'; ?>
                                                        ...
                                                        <tr>
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/EmailTemplates.php">' . _('Email Templates') . '</a></p>'; ?>
							</td>
							</tr>
						</table>
					</td>
						...
						<table width="100%" class="table_index">
							...
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/MRPDemandTypes.php">' . _('MRP Demand Types') . '</a></p>'; ?>
                                                        ...
                                                        <tr>
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/Z_DataExport.php">' . _('MYOB Integration') . '</a></p>'; ?>
							</td>
							</tr>
                                                        <tr>
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/Z_DataQBExport.php">' . _('QuickBook Integration') . '</a></p>'; ?>
							</td>
							</tr>
                                                        <tr>
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/Z_ImportCSVData.php">' . _('CSV Data Import') . '</a></p>'; ?>
							</td>
							</tr>
						</table>
					</td>
				...
				<table width="100%">		<!-- Gereral Ledger Option Headings-->
					...
					<td class="menu_group_items"> <!-- General transactions options -->
						<table width="100%" class="table_index">
                                                        <tr>
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/Z_RePostGLFromPeriod.php">' . _('Re-post ALL GL Reports') . '</a></p>'; ?>
							</td>
							</tr>
							<tr>
							<td class="menu_group_item">
