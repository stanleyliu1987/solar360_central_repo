...
/*	 ** CUSTOMER SHOULD NOT MODIFY THIS FILE **
     ...
     PHP API for Star Track Express eService
     Star Track Express
     25 May 2011
	 Version 4.3
     --------------------------------------------------------
     ...
     PURPOSE
     This software is provided to customers of Star Track Express to simplify the development of PHP-based customer software 
     interfacing to Star Track Express systems via eServices. Customers may alternatively interface directly to eServices, using any 
     programming language.

     DISCLAIMER
     This software is provided by Star Track Express as-is and without warranty. Star Track Express will not be liable for any 
     defects or omissions herein.
     
     REQUIREMENTS
     * PHP Web Server V5 with the following extensions enabled in php.ini: soap, cURL and openssl.

     * The following items supplied by Star Track Express:
         -- WSDL files for staging and for production
		 -- Username and password for specific customer account (as used for access to Star Track Express web portal), with
...
// ****************
	...
	// Invokes Star Track Express web service using supplied request and returns the response
...
//											'trace' => true,
	...
	Input parameters (case-insensitive):
		...
		$verbosity = 'brief' for short description - same terminology as Star Track Express website Track-and-Trace, or
...
// These mappings may vary from time to time and so should be peridically reviewed by Star Track Express.
...
private function freightItemBriefDescriptionMap()
	...
	// Note: Suburb is as per Star Track Express list of suburbs
	{
