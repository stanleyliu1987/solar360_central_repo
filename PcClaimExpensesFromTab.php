...
/* $Id: PcClaimExpensesFromTab.php 4567 2011-05-15 04:34:49Z daintree $*/
...
if (!isset($SelectedTabs)){
	...
	echo '<p class="page_title_text"><img src="'.$rootpath.'/css/'.$theme.'/images/money_add.png" title="' . _('Petty Cash Claim Entry')
	. '" alt="" />' . ' ' . $title . '</p>';
