...
/* $Id: MiscFunctions.php 4580 2011-05-29 04:45:11Z daintree $*/
...
function userLogin($SearchEmailString,$InvoiceNumber,$db){
    
    $sql="Select * from onlineordertracking where email like '".$SearchEmailString."' and
                                                 order_='".$InvoiceNumber."'";
...
function destorySession(){
    session_destroy();
    echo 'Session Has been expired, Automatically Rediect to the login page';
...
function CheckSessionExpire(){
  ...
  if(($now - $_SESSION['expire'])>100 and isset($_SESSION['expire']))
    {
       destorySession();
    }
}
